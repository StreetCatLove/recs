...
* this site relies on my quota limits for the twitch and google api -  contact me to allow your site to use my api workers or set up your own proxy with cloudflare workers using the included assets/js/TwitchWorker.js and assets/js/YTWorker.js
